...
@NgModule({
  declarations: [AppComponent, ...APP_CONTAINERS, IndexComponent, LoginComponent, RegisterComponent, BooksComponent, FormBooksComponent, AuthorsComponent, FormAuthorsComponent],
  imports: [
    BrowserModule,
